...
RUN /usr/sbin/unbound-anchor -r /var/lib/unbound/root.hints -a /var/lib/unbound/root.key ; true && \
	chown -R unbound:unbound /var/lib/unbound/
HEALTHCHECK --interval=5m --timeout=10s --start-period=10s --retries=3 CMD drill -D -p 8353 cloudflare.com @127.0.0.1 | egrep -q 'flags:[a-z ]*ad{1}.*;' || exit 1
